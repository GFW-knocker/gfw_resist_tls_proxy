...
class ThreadedServer:
    ...
    def listen(self):
        ...
        while True:
            ...
            thread_up = threading.Thread(target=self.my_upstream, args=(client_sock,), daemon=True)
            thread_up.start()
    ...
    def my_upstream(self, client_sock):
        ...
        try:
            ...
            thread_down = threading.Thread(target=self.my_downstream, args=(backend_sock, client_sock), daemon=True)
            thread_down.start()
